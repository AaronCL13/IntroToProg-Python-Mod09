# ---------------------------------------------------------------------#
# Title: IO Classes
# Desc: A module with classes for input/output functions
# Changed Log: (Who, When, What)
# ALanphear, 3.11.21, Created script
# ---------------------------------------------------------------------#
...
class EmployeeIO:
    ...
    def print_current_list_items(list_of_rows: list):
        ...
        for row in list_of_rows:
            print(Dc.Employee(str(row.employee_id), row.first_name, row.last_name))
        print("*******************************************")
        print()  # Add an extra line for looks
